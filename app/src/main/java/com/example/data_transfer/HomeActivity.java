...
public class HomeActivity extends Activity {
        ...
        imgUser.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View view) {
                        Intent imageActivityIntent =new Intent(HomeActivity.this,ImagesActivity.class);
                        startActivityForResult(imageActivityIntent,1);
                    }
                }
        );
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(data!=null){
            int imagesId =data.getExtras().getInt("image_id");
            imgUser.setImageResource(imagesId);
        }
    }
}
